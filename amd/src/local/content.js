...
import Section from 'format_eloflexsections/local/content/section';
import CmItem from 'core_courseformat/local/content/section/cmitem';
import Mutations from "format_eloflexsections/local/courseeditor/mutations";
import EloflexsectionsActions from 'format_eloflexsections/local/content/actions';
import Exporter from "format_eloflexsections/local/courseeditor/exporter";

/**
 * Course format component
 *
 * @module     format_eloflexsections/local/content
...
export default class FlexsectionComponent extends Component {
    ...
    create(descriptor) {
        ...
        this.name = 'course_format_eloflexsections';
    ...
    stateReady(state) {
        ...
        if (this.reactive.supportComponents) {
            ...
            if (this.reactive.isEditing) {
                new EloflexsectionsActions(this);
            }
        }
     ...
     */
    _mainSection() {
        return parseInt(this.element.getAttribute('data-eloflexsections-mainsection'));
    }
