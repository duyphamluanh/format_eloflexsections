...
import Exporter from "format_eloflexsections/local/courseeditor/exporter";

/**
 * Course index main component.
 *
 * @module     format_eloflexsections/local/courseindex/courseindex
...
export default class Component extends BaseCourseindex {
    ...
    create(descriptor) {
        ...
        this.name = 'course_format_eloflexsections_courseindex';
    ...
    _refreshCourseSectionlist({element}) {
        ...
        for (let i = 0; i < hierarchy.length; i++) {
            ...
            this._fixOrderEloflexsections(listparent, hierarchy[i].children, dettachedSections);
        }
        this._fixOrderEloflexsections(this.element, element.sectionlist ?? [], dettachedSections);
    }
     ...
     */
    async _fixOrderEloflexsections(container, neworder, dettachedelements) {
    ...
    async _createSection({state, element}) {
        ...
        const newcomponent = await this.renderComponent(sectionItem, 'format_eloflexsections/local/courseindex/section', data);
