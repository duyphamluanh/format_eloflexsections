...
namespace format_eloflexsections\courseformat;
...
class stateactions extends  \core_courseformat\stateactions {
     ...
     *
     * @param \format_eloflexsections\courseformat\stateupdates $updates the affected course elements track
    ...
    protected function check_maxdepth(stdClass $course, \section_info $targetsection) {
        ...
        if ($targetsectiondepth >= $format->get_max_section_depth()) {
            throw new moodle_exception('errorsectiondepthexceeded', 'format_eloflexsections');
        }
    }
