...
namespace format_eloflexsections\output\courseformat\content;
...
class section extends \core_courseformat\output\local\content\section {
    ...
    /** @var \format_eloflexsections the course format */
    protected $format;
    ...
    public function get_template_name(\renderer_base $renderer): string {
        return 'format_eloflexsections/local/content/section';
    }
    ...
    public function export_for_template(\renderer_base $output): stdClass {
        ...
        $showaslink = false;
        // $this->section->collapsed == FORMAT_ELOFLEXSECTIONS_COLLAPSED
