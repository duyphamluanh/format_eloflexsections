...
class header extends \core_courseformat\output\local\content\section\header {
    ...
    public function get_template_name(\renderer_base $renderer): string {
        return 'format_eloflexsections/local/content/section/header';
    }
    ...
    public function export_for_template(\renderer_base $output): \stdClass {
        ...
        // if ($this->section->collapsed == FORMAT_ELOFLEXSECTIONS_COLLAPSED) {
    ...
    protected function title_needs_indenting(): bool {
        $hassections = [FORMAT_ELOFLEXSECTIONS_COLLAPSED => false, FORMAT_ELOFLEXSECTIONS_EXPANDED => 0];
        ...
        return $hassections[FORMAT_ELOFLEXSECTIONS_EXPANDED] && $hassections[FORMAT_ELOFLEXSECTIONS_COLLAPSED];
    }
}
