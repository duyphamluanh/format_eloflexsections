...
namespace format_eloflexsections\output;

use action_link;
use core_courseformat\base as course_format;
use core_courseformat\output\section_renderer;
use format_eloflexsections_edit_control;
use html_writer;
use moodle_page;
use pix_icon;
use section_info;
...
/**
 * Basic renderer for Eloflexsections format.
 *
...
class renderer extends section_renderer {
    ...
    public function __construct(moodle_page $page, $target) {
        ...
        // Since format_eloflexsections_renderer::section_edit_control_items() only displays the 'Highlight' control
    ...
    public function course_index_drawer(course_format $format): ?String {
        if ($format->uses_course_index()) {
            ...
            return $this->render_from_template('format_eloflexsections/local/courseindex/drawer', []);
        }
        return '';
    }
}
