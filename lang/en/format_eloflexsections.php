...
$string['page-course-view-eloflexsections'] = 'Any course main page in Elo flexible sections format';
$string['page-course-view-eloflexsections-x'] = 'Any course page in Elo flexible sections format';
$string['pluginname'] = 'Elo flexible sections format';
$string['privacy:metadata'] = 'The Elo flexible sections format plugin does not store any personal data.';
$string['section0name'] = 'General';
$string['sectionname'] = 'Topic';
$string['showcollapsed'] = 'Display as a link';
$string['showexpanded'] = 'Display on the same page';
$string['showexpanded'] = 'Display on the same page';
$string['alwaysexpand'] = 'Always expand';
$string['expandalwaysyes'] = 'Yes';
$string['expandalwaysno'] = 'No';
