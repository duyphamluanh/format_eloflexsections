...
Feature: Return to section from activity in format eloflexsections
  ...
  Scenario: Return to section from activity in format eloflexsections (default to no link)
    When I log in as "student"
    And I am on "Course 1" course homepage
    And I follow "Page in first section"
    Then I should not see "Back to '"

  Scenario: Return to section from activity in format eloflexsections (with a link)
