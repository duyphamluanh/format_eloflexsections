...
Feature: Using course in eloflexsections format
  ...
  Background:
    ...
    And the following config values are set as admin:
      | maxsectiondepth | 4 | format_eloflexsections |
  ...
  Scenario: Add sections and activities to eloflexsections format
  ...
  Scenario: Hiding section in eloflexsections format
  ...
  Scenario: Hiding section in eloflexsections format hides the subsections and activities
  ...
  Scenario: Display section as a link in eloflexsections format
  ...
  Scenario: Display section with subsections as a link in eloflexsections format
  ...
  Scenario: Merging empty subsection in eloflexsections format
  ...
  Scenario: Merging subsection in eloflexsections format
    Given the following config values are set as admin:
      | unaddableblocks | | theme_boost|
    Given I add the "Navigation" block if not present
    When I open section "2" edit menu
