...
Feature: Collapsing and expanding sections in eloflexsections format
  ...
  Background:
    ...
    And the following "format_eloflexsections > sections" exist:
  ...
  Scenario: Collapse and expand all sections in eloflexsections format
  ...
  Scenario: Collapse and expand all sections in subsection in eloflexsections format
    When I log in as "student"
    And I am on "Course 1" course homepage
  ...
  Scenario: Expanding and collapsing sections with accordion in eloflexsections format
  ...
  Scenario: Expanding and collapsing sections with accordion and expandable General section in eloflexsections format
  ...
  Scenario: Expanding and collapsing sections on the subsection page in Elo flexible sections format
    When I log in as "student"
    And I am on "Course 1" course homepage
    And I click on "t300" "link" in the "region-main" "region"
    And I should not see "Page in General section" in the "region-main" "region"
  ...
  Scenario: Expanding and collapsing sections on the subsection page in accordion mode in Elo flexible sections format
    When I log in as "teacher"
    When I am on "Course 1" course homepage
    And I follow "Settings"
    And I set the following fields to these values:
