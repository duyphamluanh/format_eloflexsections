...
Feature: Deleting sections in eloflexsections format
  ...
  Scenario: Deleting the empty section in eloflexsections format
  ...
  Scenario: Deleting the subsection in eloflexsections format
  ...
  Scenario: Deleting the section with subsections in eloflexsections format
