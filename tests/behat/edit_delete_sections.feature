...
Feature: Sections can be edited and deleted in eloflexsections format
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | eloflexsections | 0             | 5           |
  ...
  Scenario: View the default name of the second section in eloflexsections format
    When I edit the section "2"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "Topic 2"

  Scenario: Edit section summary in eloflexsections format
    When I edit the section "2" and I fill the form with:
      | Summary | Welcome to section 2 |
    Then I should see "Welcome to section 2" in the "Topic 2" "section"

  Scenario: Edit section default name in eloflexsections format
    When I edit the section "2" and I fill the form with:
      | Custom | 1                      |
  ...
  Scenario: Inline edit section name in eloflexsections format
  ...
  Scenario: Deleting the last section in eloflexsections format
  ...
  Scenario: Deleting the middle section in eloflexsections format
  ...
  Scenario: Adding sections at the end of a eloflexsections format
